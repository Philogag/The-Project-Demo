<template>
  <Header :class="getHeaderClass">
    ...
    <div :class="`${prefixCls}-left`">
      ...
      <LayoutTrigger
        ...
        :sider="false"
      />
      <HomeTrigger :class="`${prefixCls}-action__item ml-2 mr-2`" />
    </div>
    <!-- left end -->
  ...
  <div v-if="fixed" :class="`${prefixCls}`">
    <!-- fix高度占位 -->
  </div>
</template>
<script lang="ts">
...
import HomeTrigger from "../trigger/HomeTrigger.vue";
